...
def _system_prompt() -> str:
    ...
    return (
        ...
        "- Do NOT label second-person advice or coaching as the speaker's own action. "
        "Statements directed at viewers like 'you can take a partial', 'you could move your stop', "
        "'you should trim here', 'move your stop up', 'you must TP some' are advice to the audience, "
        "NOT the speaker's own trade actions. Only label first-person present-tense actions "
        "(I'm, I am, my stop, paying myself, I'm out). "
        "The ONLY exception is when second-person language clearly co-occurs with a first-person live action "
        "on the same line (e.g. 'I'm trimming here, you should too').\n"
